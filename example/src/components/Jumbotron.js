        ...
        <div className="container">
            ...
            <p className="right-spacing">
                <a href="https://david-dm.org/bymi15/react-edit-text" title="dependencies status">
                    <img src="https://david-dm.org/bymi15/react-edit-text/status.svg?style=flat-square" alt="david dm"/>
                </a>
            ...
            <hr className="my-4"/>
            <p className="lead">This is an editable text component for React. Simply click on the text to edit!</p>
            <p>Made with <span role="img" aria-label="love">❤️</span> by <a href="https://github.com/bymi15">Brian Min</a></p>
        </div>
    </div>
);
